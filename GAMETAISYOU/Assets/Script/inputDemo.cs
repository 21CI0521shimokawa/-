...
public class inputDemo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //左スティック
        {
            float hori = Input.GetAxis("L_Stick_Horizontal");
            float vert = Input.GetAxis("L_Stick_Vertical");
            if ((hori != 0) || (vert != 0))
            {
        ...
        //右スティック
        {
            float hori = Input.GetAxis("R_Stick_Horizontal");
            float vert = Input.GetAxis("R_Stick_Vertical");
            if ((hori != 0) || (vert != 0))
            {
